    ...
    <div className="mt-5 ml-8 mr-8 h-50 bg-white rounded-lg flex flex-row justify-between">
      <div className="w-6/6 mt-5 ml-5">
        ...
        <form className="group relative bg-white rounded-lg mt-5 mr-5">
          ...
          <input className="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-lg py-2 pl-10 ring-1 ring-slate-200 shadow-sm" placeholder="Search anything" />
        </form>
